...
export function LoadClasses(): JSX.Element{
    const coreClasses=[
        ...
        {
            id: "test3",
            name: "The CAH, HCC, and SBS breadth requirements are required for the College, University Breadth, and University Requirements.",
        },
        {
            id: "test4",
            name: "2 science courses with lab can satisfy one laboratory science sequence.",
        },
        {
            id: "test5",
            name: "2 science courses with lab are required for the science course requirements.",
        },
        {  
            id: "test6",
            name: "The Multicultural requirement is required for the University Requirements.",
        },  
    ];
    /*
    ...
    */
    ...
    return (
        <div style={styles.classes}>
            <h3 style={styles.h3}>Degree Requirement List</h3>
